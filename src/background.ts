...
export function drawParallax(game: Game, c: CanvasRenderingContext2D) {
  ...
  halo.addColorStop(0, `rgba(255,244,220,${0.12 + day * 0.05})`); halo.addColorStop(1, 'rgba(0,0,0,0)');
  c.fillStyle = halo; c.beginPath(); c.arc(moonX, moonY, R * 2.8, 0, Math.PI * 2); c.fill();
