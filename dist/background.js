...
export function drawParallax(game, c) {
    ...
    if (mtn?.ready) {
        ...
        body.addColorStop(0, `rgba(255,250,236,${0.62 + day * 0.16})`);
        body.addColorStop(0.65, `rgba(255,240,212,${0.36 + day * 0.12})`);
        ...
        for (let x = start; x < LOGICAL_W + W; x += W)
            drawTintedStill(c, img, x, y0, W, H, mixHex(ridge, haze, 0.72), 0.55, 1);
    }
